      ...
      <button
        onClick={() =>
          handleAddElement({
            ...
            type: "combinator2-1",
            size: [2, 1],
            sprite: "/img/base/graphics/hr-arithmetic-combinator.png",
            spriteSize: [297, 64],
            spriteOffset: [-76, 0],
      ...
      <button
        onClick={() =>
          handleAddElement({
            ...
            type: "combinator2-1",
            size: [2, 1],
            sprite: "/img/base/graphics/hr-decider-combinator.png",
            spriteSize: [297, 64],
            spriteOffset: [-76, 0],
            backgroundSize: [64, 42],
          })
      ...
      <button
        onClick={() =>
          handleAddElement({
            ...
            type: "combinator1-1",
            size: [1, 1],
            sprite: "/img/base/graphics/hr-constant-combinator.png",
            spriteSize: [228, 54],
            spriteOffset: [-68, 2],
