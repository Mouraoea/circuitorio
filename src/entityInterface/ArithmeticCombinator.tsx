    ...
    <div className="panel-inset-lighter mt0">
      <div>
        ...
        <div className="flex-row" style={{ padding: "10px" }}>
          <input type="button" onClick={() => openSignalPicker("input1", "input")} className="button-black square40" id="input1" />
          <input type="button" className="button condition-button" id="condition" />
          <input type="button" onClick={() => openSignalPicker("input2", "input")} className="button-black square40" id="input2" />
        </div>
      </div>
      ...
      <div>
        ...
        <div style={{ display: "flex", padding: "10px" }}>
          <input type="button" onClick={() => openSignalPicker("output", "output")} className="button-black square40" id="output" />
        </div>
      </div>
    </div>
  );
